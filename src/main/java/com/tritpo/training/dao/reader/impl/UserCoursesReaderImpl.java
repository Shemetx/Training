...
public enum UserCoursesReaderImpl implements AbstractResultSetReader<ManyToManyEntity> {
    INSTANCE;
    public static UserCoursesReaderImpl getInstance() {return INSTANCE;}

    @Override
    public ManyToManyEntity oneObjectRead(ResultSet resultSet) throws SQLException {

        return ManyToManyEntity.Builder.newInstance()
                .setFirstId(resultSet.getInt("user_id"))
